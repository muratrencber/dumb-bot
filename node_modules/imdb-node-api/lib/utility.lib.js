    ...
    try {
        _request(requestUrl, function (error, response, body) {
            if (error) {
                ...
                console.log("EROOOR: "+ response.statusCode);
                return errorHandler(errorCallback, new Error('Movie failed to fetch: IMDB Failed to respond, or responded with error code: '+response.statusCode));
            }
